...
BLOG_AUTHOR = "Konstantin Stadler"  # (translatable)
BLOG_TITLE = "Konstantin Stadler"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://konstantinstadler.site/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "konstantin.stadler@ntnu.no"
BLOG_DESCRIPTION = "Plenty of lists and some code"
...
# Check with list(pygments.styles.get_all_styles()) in an interpret
...
# (translatable)
CONTENT_FOOTER = '<a href="{home}">Home</a>'
